...
export class OrderReportDashboardPage implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.checkUserType.isAnyOrgAdmin(this.role[0]) == true) {
      ...
      this.getAllOrganizationPropertyByOrgId(this.token.getOrganizationId());
    } else {
...
setActiveButton(button: string): void {
  ...
  getPOSInformation(propertyId: number) {
    ...
    this.propertyService.getAllPointOfSale(propertyId).subscribe(
      (dataOb) => {
        ...
        if (this.pointOfSaleList != null && this.pointOfSaleList != undefined && this.pointOfSaleList.length > 0)
        {
          this.pointOfSale = this.pointOfSaleList.find(data => data.counterName === counterName);
  ...
  fromDateChange() {
    let toDate = new Date(this.reportfromDateString);
...
getDate(date: Date) {
  ...
  getOrderReportsByPropertyIdAndDateRange(
    ...
    this.resource = [];
    this.reportService
      .getOrderReportsByPropertyIdAndDateRange(propertyId, formDate, toDate)
      .subscribe(
        (data) => {
          ...
          for (let i = 0; i < this.orders.length; i++) {
            if (
              ...
              if (this.resource.indexOf(this.orders[i].resourceName) === -1) {
        ...
        (data) => {
          ...
          for (let j = 0; j < this.productLineDtos.length; j++) {
            ...
            if (
                ...
                this.productGroupNameList.push(this.productLineDtos[j].productGroupName);
              }
          }
    ...
    if (this.productLineDtos.length > 0) {
      for (let i = 0; i < this.productLineDtos.length; i++) {
        if (
          ...
          this.isPriceAddedtoTotal(this.productLineDtos[i].productStatus) ===
            true
        ) {
      ...
      searchResult =
        (this.OrderStatus === null ||
          ...
          (this.OrderStatus != null &&
            ...
            this.OrderStatus.some(
              (m) => m.toLowerCase() === item.orderStatus.toLowerCase()
            ) === true &&
            this.OrderStatus.filter((m) => this.checkOrderStatus(m)))) &&
        (this.deliveryMethod === null ||
          ...
          (this.deliveryMethod != null &&
            ...
            this.deliveryMethod.some(
              (m) => m.toLowerCase() === item.deliveryMethod.toLowerCase()
            ) === true &&
        ...
        (this.source === null ||
          ...
          (this.source != null &&
            ...
            item.externalSite != undefined &&
            this.source.some(
              (m) => m.toLowerCase() === item.externalSite.toLowerCase()
            ) === true &&
        ...
        (this.serviceId === "0" || this.serviceId === null ||
          this.serviceId === undefined ||
          (this.serviceId != null &&
            this.serviceId != undefined &&
            this.serviceId != "0" &&
        ...
        (this.resourceName === null ||
          ...
          (this.resourceName != null &&
            ...
            item.resourceName != null &&
            item.resourceName != undefined &&
            this.resourceName.some((m) => m === item.resourceName) === true &&
            this.resourceName.filter((m) => this.checkResourceName(m))));
        ...
        (this.productName === null ||
          ...
          (this.productName != null &&
            ...
            this.productName.some(
              (m) => m.toLowerCase() === item.productName.toLowerCase()
            ) === true &&
            this.productName.filter((m) => this.checkProductName(m)))) &&
            (this.productGroupName === null ||
              ...
              (this.productGroupName != null &&
                ...
                this.productGroupName.some(
                  (m) => m.toLowerCase() === item.productGroupName.toLowerCase()
                ) === true &&
                this.productGroupName.filter((m) => this.checkProductGroupName(m))));
  ...
  filterProductLinesByBusinessServiceId(businessServiceId){
    ...
    if (businessServiceId != 0) {
      this.productLineDtos = this.productLineDtos.filter((pl)=> pl.businessServiceId == businessServiceId);
    }
    ...
    for (let j = 0; j < this.productLineDtos.length; j++) {
      ...
      if (
        ...
        if (this.productLineDtos[j].productGroupName != null && this.productLineDtos[j].productGroupName != undefined
