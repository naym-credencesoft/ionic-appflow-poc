export const environment = {
  production: true,
  showLog: false,
  sessionAppId: 'BOOKONE_MOBILE_APP_BUSINESS',
  countries: [
    {
      code: 'NZ',
      name: 'New Zealand',
      url: {    
        ...
        coreApi: 'https://api.bookone.io/api-bookone',
        apiUrlInventory: 'https://api.bookone.io/api-ims',
        apiUrlEms: 'https://api.bookone.io/api-ems',
        promotionApi: 'https://api.bookone.io/promotion-api',
        promotionApis:'https://api.bookone.io/promotion',
...
//         name: 'New Zealand',
//         url: {
//           coreApi: 'https://api.bookonelocal.co.nz/api-bookone',
//           apiUrlInventory: 'https://api.bookonelocal.co.nz/api-ims',
//           apiUrlEms: 'https://api.bookonelocal.co.nz/api-ems',
//           promotionApi: 'https://api.bookonelocal.co.nz/promotion-api',
//           addressApi: 'https://api.bookonelocal.co.nz/api-address',
//           channelIntegrationApi: 'https://api.bookonelocal.co.nz/channel-integration'
//         }
//       },
//       {
//         code: 'IN',
