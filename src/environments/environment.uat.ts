export const environment = {
    ...
    //     {
    //         code: 'NZ',
    //         name: 'New Zealand - UAT',

    //         url: {
    //             coreApi: 'https://api.blbl.co.nz/api-bookone',
    //             promotionApi: 'https://api.blbl.co.nz/promotion-api',
    //             addressApi: 'https://api.blbl.co.nz/api-address',
    //             channelIntegrationApi: 'https://api.blbl.co.nz/channel-integration'
    //         }
    //     },
    //     {
    //         code: 'IN',
